...
#define CS2A __REG(IMX_WEIM_BASE + 0x24) /* Chip Select 2 Lower Register    */
#define CS0L __REG(IMX_WEIM_BASE + 0x28) /* Chip Select 2 Addition Register */
#define CS3U __REG(IMX_WEIM_BASE + 0x30) /* Chip Select 3 Upper Register    */
#define CS3A __REG(IMX_WEIM_BASE + 0x34) /* Chip Select 3 Lower Register    */
#define CS0L __REG(IMX_WEIM_BASE + 0x38) /* Chip Select 3 Addition Register */
