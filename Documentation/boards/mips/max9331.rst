...
The useless board always shipped with the latest barebox and kernel. OpenWRT
is supported too.
...
Barebox can be programmed to the board with:
...
by default, the barebox bootloader is not located in the beginning of flash,
instead we have a so called program boot0, it is a very simple program,
it jumps to 0x9f020000 where the first instruction of barebox is.
This is useful when debugging with jtag or choosing different bootloaders.
