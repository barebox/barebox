...
"Overview\n"
"--------\n"
"Some features may be built directly into uboot.\n"
"Some may be made into loadable runtime modules.  Some features\n"
"may be completely removed altogether.  There are also certain\n"
"uboot parameters which are not really features, but must be\n"
...
"between different uboot configurations.\n"
"\n"
...
"------------------------------\n"
"If you prefer to have all of the uboot options listed in a single\n"
...
nohelp_text[] = N_(
	"There is no help available for this uboot option.\n"),
load_config_text[] = N_(
...
load_config_help[] = N_(
	"\n"
	"For various reasons, one may wish to keep several different uboot\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than\n"
	"uboot's default, entering the name of the file here will allow you\n"
...
save_config_help[] = N_(
	"\n"
	"For various reasons, one may wish to keep different uboot\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	do {
		cprint_init();
		cprint("--yesno");
		cprint(_("Do you wish to save your new uboot configuration?"));
		cprint("5");
		cprint("60");
		stat = exec_conf();
	} while (stat < 0);
	...
	if (stat == 0) {
		if (conf_write(NULL)) {
			fprintf(stderr, _("\n\n"
				...
				"Your uboot configuration changes were NOT saved."
				"\n\n"));
			return 1;
		}
		printf(_("\n\n"
			"*** End of Linux uboot configuration.\n"
			"*** Execute 'make' to build the uboot or try 'make help'."
			"\n\n"));
	} else {
		fprintf(stderr, _("\n\n"
			"Your uboot configuration changes were NOT saved."
