...
typedef struct lpddr4_obj_s {
	...
	u32 (*writectlconfig)(const lpddr4_privatedata *pd, struct reginitdata *regs);

	u32 (*writephyconfig)(const lpddr4_privatedata *pd, struct reginitdata *regs);

	u32 (*writephyindepconfig)(const lpddr4_privatedata *pd, struct reginitdata *regs);
