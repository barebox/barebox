...
static struct font_desc font_ter_16x32 = {
	.name	= "TER16x32",
	.width	= 16,
	.height	= 32,
...
static int font_ter16x32_register(void)
{
	return font_register(&font_ter_16x32);
}
postcore_initcall(font_ter16x32_register);
