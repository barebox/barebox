...
SDRAM initialization for us. We can use U-Boot for that.

Building barebox
----------------

The RK3288 boards in barebox are covered by the ``rockchip_v7a_defconfig``.
...
For the first stage bootloader we will need a U-Boot image. A detailed
