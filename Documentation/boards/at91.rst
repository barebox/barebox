...
The Microchip (former Atmel) AT91 architecture has very good support within
barebox.
...
The boot process of the AT91 CPUs is a two step process.
...
The bootstrap program is loaded by a boot program and can be loaded
from DataFlash, NAND Flash, SD Card or via USB.
The bootstrap program does the low-level configuration of the
processor and then loads and executes barebox.
...
::
  ...
  barebox-sama5d27-som1-ek-xload.img
  barebox-groboards-sama5d27-giantboard.img
  barebox-groboards-sama5d27-giantboard-xload.img
...
* Update remaining boards to support multi image boot
